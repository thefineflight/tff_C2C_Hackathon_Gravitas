...
if gx:
    ax1.scatter(gx, gy, marker='^', s=60, color='green', linewidths=0, label='Golden Crossover')
if dx:
    ax1.scatter(dx, dy, marker='v', s=60, color='red', linewidths=0, label='Death Crossover')
